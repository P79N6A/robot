...
/**
 * 
 * http://www.cnblogs.com/lr393993507/p/5234857.html
 * @author hyb
 *
 */
public class RegexHelper {
     ...
     * @return
     */
    public  static  boolean simpleCheckMobile(String mobile){
        String regex = "(\\d+){3,11}$";
        return Pattern.matches(regex,mobile);
    }
    ...
    public static boolean checkIdCode(String idCode) { 
        ...
        return Pattern.matches(regex, idCode); 
    } 
    
    public static boolean check16Num(String idCode){
