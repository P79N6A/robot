...
public class MacConfirm {
	 ...
	 * 报文校验密钥常量
	 */
	private static final String KEY = "botler#bao@BanW@.Boss";
	 ...
	 * @throws Exception
	 */
	private static String getCheckMac(String data01, String dateTime) {
	 ...
	 * @throws Exception
	 */
	public static Boolean checkMac(String mac, String data, String dateTime) {
	 ...
	 * @throws Exception
	 */
	public static String getMacForMobile(String data, String dateTime) {
